...
--
-- Host: localhost:3306
-- Generation Time: May 11, 2017 at 02:26 PM
...
--
-- Dumping data for table `product_invetory`
--

INSERT INTO `product_invetory` (`id`, `product_ID`, `product_Counting_Group`, `product_Unit`, `quality_Unit`, `price_Unit`, `product_Description`, `URL`, `estimated_Delivery_Time`) VALUES
(1, 1, 'Acc', 'product', 24, 12.25, 'a mechanical or electrical device for measuring time, indicating hours, minutes, and sometimes seconds by hands on a round dial or by displayed figures.', 'http://www.homestoreandmore.ie/clocks/antique-wall-clock-20/invt/059374', '2 days');
...
CREATE TABLE `quotation` (
  ...
  `product_Name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `product_Description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `request_on` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `quotation` (`id`, `quotation_no`, `user_id`, `suppliers_id`, `product_Name`, `product_Description`, `request_on`) VALUES
(1, 1, 1, 2, 'Coffee', 'Restain and Refresh Grout with Coffee', 'April 2017');
...
--
-- Table structure for table `user_r_o_l_e`
--

CREATE TABLE `user_r_o_l_e` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `user_r_o_l_e`
--
ALTER TABLE `user_r_o_l_e`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_8A74A334C7811FAF` (`userROLE`);
...
ALTER TABLE `user_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `user_r_o_l_e`
--
ALTER TABLE `user_r_o_l_e`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
